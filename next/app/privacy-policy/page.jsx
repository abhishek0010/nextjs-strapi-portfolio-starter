    ...
    return (
      <div className="mx-auto max-w-7xl p-4">
        <div className="text-red-600 text-center">
          Error: We encountered an issue while loading the &quot;Privacy
          policy&quot; page.
        </div>
      </div>
    );
  ...
  if (global.status === "fulfilled") {
    ...
    jsonLd = {
      ...
      "@graph": [
        {
          "@type": "WebPage",
          "@id": new URL("/privacy-policy/", process.env.NEXT_PUBLIC_WEBSITE)
            .href,
          name: title ? title : `Privacy policy | ${siteName}`,
          description: description ? description : siteDescription,
          url: new URL("/privacy-policy/", process.env.NEXT_PUBLIC_WEBSITE)
            .href,
