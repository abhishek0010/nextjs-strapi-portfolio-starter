...
export default async function Footer({ data, siteRepresentation }) {
      ...
      <div className="bg-neutral-950">
        <div className="mx-auto max-w-7xl p-4">
          <div className="text-red-600 text-center">
            Error: We encountered an issue while loading the &quot;Footer&quot;
            component.
          </div>
        </div>
      </div>
  ...
  return (
    <footer>
      <Link
        className="text-white/75 text-base transition hover:underline bg-neutral-800 block text-center px-4 py-2"
        href="#"
      >
        Back to top
      </Link>
      ...
      <div className="bg-neutral-950">
        <div className="mx-auto max-w-7xl px-4 py-24">
          ...
          <div className="flex flex-col md:flex-row md:justify-between">
            ...
            <p className="text-white/75 text-base md:order-1 text-center">
              {copyright}
            </p>
          </div>
        </div>
